...
import { FarmacySensor, Sensor } from '../../sensors/sensor.entity';
import { FarmacySensorReading, SensorReading } from 'src/sensorReadings/sensorReading.entity';
...
export class SensorService {
  constructor(
    @InjectRepository(FarmacySensor, 'sensors')
    private readonly sensorsRepository: Repository<FarmacySensor>,
  ) { }

  create(createSensorDto: CreateSensorDto): Promise<Sensor> {
    const sensor = new FarmacySensor();
...
export class SensorReadingsService {
  constructor(
    @InjectRepository(FarmacySensorReading, 'sensors')
    private readonly sensorReadingsRepository: Repository<FarmacySensorReading>,
  ) { }

  createOne(createSensorReadingDto: CreateSensorReadingDto): Promise<SensorReading> {
    const sensorReading = new FarmacySensorReading();
